...
## 3. Making
### a. Building 
Now we finally come to the part of which the entire bootcamp is based on. Making the product. We started with desiging the shelves using the [layout.](https://github.com/ashish-waghmare0312/MakerMania_2026_TEAM_Draft_Punk/blob/main/images/Sensor%20Cupboard%20Layout.jpg) For the hardware we used RFID for the recognition, a display, a microcontrolle, and other components which we cycled through for the WiFi and the locking system.
...
We also had problems finding the accurate locking system, cycling through solenoid and servo options.
### c. Finishing
